...
import NetatmoChartsData, {Scale, Types} from "../../models/NetatmoChartsData";
...
export const fetchMeasure = (device: string, module: string, types: string[], timelapse: '12h'|'1d'|'1m'): ThunkAction<void, ApplicationState, null, Action<string>> => {
    return (dispatch, getState) => {
...
export const successMeasures = (data: any, module: string, timelapse: '12h'|'1d'|'1m') => {
    return {
...
export const fetchMeasures = (device: string, module: string, types: Types[], timelapse: '12h'|'1d'|'1m', module_name: string): ThunkAction<void, ApplicationState, null, Action<string>> => {
    return (dispatch, getState) => {
        // Get measure only if we have no data or if the last fetch is bigger than 10 minutes
...
export const onChangeSelectedType = (type: Types, module: string) => {
    return {
