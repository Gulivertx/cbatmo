...
const mapStateToProps = ({ netatmo, application}: ApplicationState) => ({
    module_data: netatmo.station_data?.modules.INDOOR_THIRD,
    ...
    selected_type: netatmo.selected_indoor_third_type,
    measure_data: netatmo.measure_indoor_third_data,
});
...
const ModuleNetatmoIndoorThirdContainer = connect(
    mapStateToProps,
    mapDispatchToProps
)(ModuleNetatmoIndoor);

export default ModuleNetatmoIndoorThirdContainer
